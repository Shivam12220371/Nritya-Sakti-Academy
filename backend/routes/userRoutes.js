...
const { uploadProfileImage, markVideoWatched, getStudentVideos, getStudentClasses, processFeePayment, getStudentAttendance } = require('../controllers/userController');
